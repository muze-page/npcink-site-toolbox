...
if (!class_exists('MaMi_Function_Auxiliary')) {
    class MaMi_Function_Auxiliary
    {
        ...
        {
            //加载文章统计
            $single_count = MaMi_Admin::get_config($option, 'single_count');
            ...
            //屏蔽恶意关键词搜索
            $no_malice_key = MaMi_Admin::get_config($option, 'no_malice_key'); //状态
            $keyword_arr = MaMi_Admin::get_config($option, 'malice_keu_content'); //关键词数组
