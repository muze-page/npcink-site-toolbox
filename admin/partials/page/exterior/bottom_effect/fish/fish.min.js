jQuery(document).ready(function ($) {
  var RENDERER = {
      ...
      generateEpicenter: function (t, i, e) {
        if (
          !(
            i < this.height / 2 - this.THRESHOLD ||
            i > this.height / 2 + this.THRESHOLD
          )
        ) {
  ...
  SURFACE_POINT.prototype = {
    ...
    interfere: function (t, i) {
      this.fy =
        ...
        (this.renderer.height - this.height - t >= 0 ? -1 : 1) *
        Math.abs(i);
    },
    updateSelf: function () {
  ...
  (FISH.prototype = {
    ...
    render: function (t) {
      t.save(),
        ...
        t.save(),
        t.translate(40, 0),
        t.scale(0.9 + 0.2 * Math.sin(this.theta), 1),
        t.beginPath(),
        t.moveTo(0, 0),
        ...
        this.renderer.reverse
          ? (t.moveTo(5, 0),
            t.bezierCurveTo(10, 10, 10, 30, 0, 40),
            t.bezierCurveTo(-12, 25, -8, 10, 0, 0))
          : (t.moveTo(-5, 0),
            t.bezierCurveTo(-10, -10, -10, -30, 0, -40),
            t.bezierCurveTo(12, -25, 8, -10, 0, 0)),
        t.closePath(),
