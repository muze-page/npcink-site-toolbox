...
if (!class_exists('Npcink_Login_Beautify')) {
    class Npcink_Login_Beautify
    {
        ...
        {
            //登录页LOGO改为首页链接
            $modify_login_link = MaBox_Admin::get_config($beautify, 'modify_login_link');
            ...
            //移除登录页语言选择器
            $remove_langue = MaBox_Admin::get_config($beautify, 'remove_langue');
            ...
            //自定义登录页
            $custom_login_page = MaBox_Admin::get_config($beautify, 'custom_login_page');
