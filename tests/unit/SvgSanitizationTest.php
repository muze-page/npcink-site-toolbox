...
/**
 * MaBox_Medium_Svg_Support 单元测试
 *
 * 测试 SVG 清洗逻辑，确保危险标签和属性被正确移除
 */
class MaBox_Svg_Sanitization_Test extends TestCase {

    /**
     * 测试 SVG Support 类存在
     */
    public function test_class_exists(): void {
        $this->assertTrue(class_exists('MaBox_Medium_Svg_Support'));
    }
    ...
    public function test_sanitize_method_exists(): void {
        $this->assertTrue(method_exists('MaBox_Medium_Svg_Support', 'sanitize_svg_content'));
    }
