...
final class JurisdictionContentRuntimeTest extends TestCase
{
    ...
    public function test_anonymous_page_receives_a_server_rendered_sanitized_notice(): void
    {
        ...
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Page', 'id_array', array('42'));
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Page', 'tip_content', '<strong>请登录</strong><script>alert(1)</script>');

        $output = Npcink_Toolbox_Page_Hide_Page::restrict_content_for_specific_categories('<p>私密正文</p>');
    ...
    public function test_anonymous_tag_and_category_receive_the_same_notice_contract(): void
    {
        ...
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Tag', 'id_array', array(7));
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Tag', 'tip_content', '<em>登录后查看</em>');
        $this->assertSame(
            '<em>登录后查看</em>',
            Npcink_Toolbox_Page_Hide_Tag::restrict_content_for_specific_tags('<p>私密正文</p>')
        );

        $GLOBALS['_test_category_ids'] = array(9);
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Category', 'id_array', array(9));
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Category', 'tip_content', '<em>登录后查看</em>');
        $this->assertSame(
            '<em>登录后查看</em>',
            Npcink_Toolbox_Page_Hide_Category::restrict_content_for_specific_categories('<p>私密正文</p>')
        );
    }
    ...
    public function test_logged_in_reader_keeps_original_content(): void
    {
        ...
        $GLOBALS['_test_post_id'] = 42;
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Page', 'id_array', array(42));
        $this->setStaticProperty('Npcink_Toolbox_Page_Hide_Page', 'tip_content', '请登录');

        $this->assertSame(
            '<p>完整正文</p>',
            Npcink_Toolbox_Page_Hide_Page::restrict_content_for_specific_categories('<p>完整正文</p>')
        );
    }
