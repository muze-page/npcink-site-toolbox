...
require_once dirname(__DIR__, 2) . '/includes/class-mabox-config-schema.php';
...
final class ConfigSchemaExceptionEscapingTest extends TestCase
{
    public function test_dynamic_exception_messages_are_deferred_to_the_output_boundary(): void
    {
        $source = file_get_contents(
            dirname(__DIR__, 2) . '/includes/class-mabox-config-schema.php'
        );
    ...
    {
        $method = new ReflectionMethod('MaBox_Config_Schema', 'append_search_item');
