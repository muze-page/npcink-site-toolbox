...
/**
 * Npcink_Toolbox_Helpers 单元测试
 *
 * 测试公共工具类的核心逻辑
 */
class Npcink_Toolbox_Helpers_Test extends TestCase {

    /**
     * 测试 Helpers 类存在
     */
    public function test_helpers_class_exists(): void {
        $this->assertTrue(class_exists('Npcink_Toolbox_Helpers'));
    }
    ...
    public function test_get_config_method_exists(): void {
        $this->assertTrue(method_exists('Npcink_Toolbox_Helpers', 'get_config'));
    }
    ...
    public function test_get_merged_config_method_exists(): void {
        $this->assertTrue(method_exists('Npcink_Toolbox_Helpers', 'get_merged_config'));
    }
    ...
    public function test_get_config_handles_zero_value(): void {
        // 验证方法签名支持默认值参数
        $method = new ReflectionMethod('Npcink_Toolbox_Helpers', 'get_config');
